...
export type PrescriptionQueueItem={id:string;prescriptionId:string;createdAt:string;status:string;visit:{id:string;visitNumber:string;visitDate:string};patient:{id:string;uhid?:string|null;firstName?:string|null;middleName?:string|null;lastName?:string|null;primaryMobile?:string|null};doctor:{id:string;doctorCode:string;specialization:string;title?:string|null;firstName?:string|null;middleName?:string|null;lastName?:string|null;employee?:{firstName?:string|null;middleName?:string|null;lastName?:string|null}|null};department?:{departmentName?:string|null}|null;items:Array<{id:string;medicineId?:string|null;medicineName:string;dosage?:string|null;frequency?:string|null;durationDays?:number|null;prescribedQuantity?:string|number|null;instructions?:string|null;medicine?:{id:string;medicineCode:string;brandName:string;genericName?:string|null;strength?:string|null;dosageForm?:string|null;totalAvailable:number;batches:Array<{id:string;batchNumber:string;expiryDate:string;availableQuantity:string|number;sellingPrice:string|number;rackLocation?:string|null}>}|null}>};
